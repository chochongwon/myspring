...
<body>
	...
	<a href="#this" class="btn" id="deleteGb">삭제하기</a>
	<a href="#this" class="btn" id="delete">완전삭제</a>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#deleteGb").on("click", function(e){ //삭제하기 버튼
				e.preventDefault();
				fn_deleteGbBoard();
			});
			
			$("#delete").on("click", function(e){ //완전삭제 버튼
				e.preventDefault();
				fn_deleteBoard();
			});
		...
		function fn_deleteGbBoard(){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/sample/deleteGbBoard.do' />");
