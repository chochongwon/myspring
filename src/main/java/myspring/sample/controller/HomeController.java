...
public class HomeController {
	...
	@RequestMapping(value = "/sample/i18n.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/sample/login.do", method = RequestMethod.GET)
	public String login(Locale locale, Model model) {
		logger.info("Welcome login! The client locale is {}.", locale);
		
		return "sample/login";
	}
    @RequestMapping(value="/sample/testLoggerInterceptor.do")
