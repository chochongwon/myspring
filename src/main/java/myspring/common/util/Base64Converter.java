...
import myspring.common.data.XmlString;
...
public class Base64Converter {
    ...
    static 
    {
        log = LogFactory.getLog(myspring.common.util.Base64Converter.class);
    ...
    {
        char ac[] = encodeChar(abyte0);
        return ac != null ? new String(ac) : null;
    }

    public static char[] encodeChar(byte abyte0[])
    {
        if(abyte0 == null)
            return null;
        ...
        if(log.isDebugEnabled())
            log.debug("fewerThan24bits=" + j + ", numberTriplets=" + k + ", numberQuartet=" + l + ", numberLines=" + i1);
        char ac[] = null;
        ac = new char[l * 4 + i1];
        boolean flag = false;
        boolean flag1 = false;
        ...
        for(int i2 = 0; i2 < i1 - 1; i2++)
        {
            for(int j2 = 0; j2 < 19; j2++)
            {
                ...
                byte byte16 = (byte7 & -128) != 0 ? (byte)(byte7 >> 2 ^ 192) : (byte)(byte7 >> 2);
                byte byte20 = (byte11 & -128) != 0 ? (byte)(byte11 >> 4 ^ 240) : (byte)(byte11 >> 4);
                byte byte23 = (byte14 & -128) != 0 ? (byte)(byte14 >> 6 ^ 252) : (byte)(byte14 >> 6);
                ac[j1++] = lookUpBase64Alphabet[byte16];
                ac[j1++] = lookUpBase64Alphabet[byte20 | byte0 << 4];
                ac[j1++] = lookUpBase64Alphabet[byte4 << 2 | byte23];
        ...
        for(; l1 < k; l1++)
        {
            ...
            byte byte17 = (byte8 & -128) != 0 ? (byte)(byte8 >> 2 ^ 192) : (byte)(byte8 >> 2);
            byte byte21 = (byte12 & -128) != 0 ? (byte)(byte12 >> 4 ^ 240) : (byte)(byte12 >> 4);
            byte byte24 = (byte15 & -128) != 0 ? (byte)(byte15 >> 6 ^ 252) : (byte)(byte15 >> 6);
            ac[j1++] = lookUpBase64Alphabet[byte17];
            ac[j1++] = lookUpBase64Alphabet[byte21 | byte1 << 4];
            ac[j1++] = lookUpBase64Alphabet[byte5 << 2 | byte24];
        ...
        if(j == 8)
        {
            ...
            byte byte18 = (byte9 & -128) != 0 ? (byte)(byte9 >> 2 ^ 192) : (byte)(byte9 >> 2);
        ...
        if(j == 16)
        {
            ...
            byte byte19 = (byte10 & -128) != 0 ? (byte)(byte10 >> 2 ^ 192) : (byte)(byte10 >> 2);
            byte byte22 = (byte13 & -128) != 0 ? (byte)(byte13 >> 4 ^ 240) : (byte)(byte13 >> 4);
            ac[j1++] = lookUpBase64Alphabet[byte19];
            ac[j1++] = lookUpBase64Alphabet[byte22 | byte3 << 4];
    ...
    public static void encodeAndWrite(byte abyte0[], PrintWriter printwriter)
    {
        if(log.isTraceEnabled())
            log.trace("bin=" + (abyte0 != null ? String.valueOf(abyte0.length) : "null"));
        if(abyte0 == null)
            return;
        int i = abyte0.length * 8;
        if(log.isDebugEnabled())
            log.debug("lengthDataBits=" + i);
        if(i == 0)
            return;
        int j = i % 24;
        int k = i / 24;
        ...
        for(int l1 = 0; l1 < i1 - 1; l1++)
        {
            for(int i2 = 0; i2 < 19; i2++)
            {
                ...
                byte byte11 = abyte0[j1++];
                byte byte14 = abyte0[j1++];
                byte byte4 = (byte)(byte11 & 15);
                byte byte0 = (byte)(byte7 & 3);
                byte byte16 = (byte7 & -128) != 0 ? (byte)(byte7 >> 2 ^ 192) : (byte)(byte7 >> 2);
                byte byte20 = (byte11 & -128) != 0 ? (byte)(byte11 >> 4 ^ 240) : (byte)(byte11 >> 4);
                byte byte23 = (byte14 & -128) != 0 ? (byte)(byte14 >> 6 ^ 252) : (byte)(byte14 >> 6);
                printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte16]));
                printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte20 | byte0 << 4]));
                printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte4 << 2 | byte23]));
                printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte14 & 63]));
                k1++;
            }
        ...
        for(; k1 < k; k1++)
        {
            ...
            byte byte12 = abyte0[j1++];
            byte byte15 = abyte0[j1++];
            byte byte5 = (byte)(byte12 & 15);
            byte byte1 = (byte)(byte8 & 3);
            byte byte17 = (byte8 & -128) != 0 ? (byte)(byte8 >> 2 ^ 192) : (byte)(byte8 >> 2);
            byte byte21 = (byte12 & -128) != 0 ? (byte)(byte12 >> 4 ^ 240) : (byte)(byte12 >> 4);
            byte byte24 = (byte15 & -128) != 0 ? (byte)(byte15 >> 6 ^ 252) : (byte)(byte15 >> 6);
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte17]));
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte21 | byte1 << 4]));
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte5 << 2 | byte24]));
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte15 & 63]));
        }

        if(j == 8)
        {
            byte byte9 = abyte0[j1];
            byte byte2 = (byte)(byte9 & 3);
            byte byte18 = (byte9 & -128) != 0 ? (byte)(byte9 >> 2 ^ 192) : (byte)(byte9 >> 2);
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte18]));
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte2 << 4]));
            printwriter.write(XmlString.encode('='));
            printwriter.write(XmlString.encode('='));
        } else
        if(j == 16)
        {
            ...
            byte byte13 = abyte0[j1 + 1];
            byte byte6 = (byte)(byte13 & 15);
            byte byte3 = (byte)(byte10 & 3);
            byte byte19 = (byte10 & -128) != 0 ? (byte)(byte10 >> 2 ^ 192) : (byte)(byte10 >> 2);
            byte byte22 = (byte13 & -128) != 0 ? (byte)(byte13 >> 4 ^ 240) : (byte)(byte13 >> 4);
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte19]));
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte22 | byte3 << 4]));
            printwriter.write(XmlString.encode(lookUpBase64Alphabet[byte6 << 2]));
            printwriter.write(XmlString.encode('='));
        }
        printwriter.write(XmlString.encode('\n'));
    }
